...
<head>
  ...
  <title>statement 로 데이터 입력하기</title>
...
<div class="container mt-5">
  <h2 class="text-center">Statement 데이터 입력 폼</h2>
    ...
    <div class="col-sm-4 mx-auto">
      <form action="InsertProcess.jsp" method="post">
        ...
        <div class="mt-3">
          ...
          <input type="text" class="form-control" id="user-name" name="userName" placeholder="사용자 이름을 입력해주세요">
        </div>
        <div class="mt-3 d-grid gap-2">
          <button type="submit" class="btn btn-primary" id="btn-submit">회원가입</button>
          <button type="reset" class="btn btn-secondary" id="btn-calcel">취소</button>
        </div>
      </form>
    </div>
  </div>
